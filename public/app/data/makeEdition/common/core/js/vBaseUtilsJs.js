...
function writeConditions(vBase, cSet) {
 	...
 	if (typeof standAlone!="undefined" && standAlone) {
 		...
 		window.history.replaceState(null, null, "vBase.html?view=VBase"+queryString);
 	}
...
/*		} */
		...
		if (typeof standAlone!="undefined" && standAlone) {
			...
			$("#searchVBResults").append("<div class='VBLemma'>"+myAlias+", "+vbLine+": "+lemma+' <span class="showTip VBVM'+prefix+' VBVM"><a href="html/collationreg/'+vbTale+'/'+fileRef+'.html"><img class="VBVmap" src="common/core/images/VMap.png" height="24px"></a></span></div>');
		}
		let results="<div>";
